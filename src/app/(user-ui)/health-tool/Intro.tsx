        ...
        <div>
            <section className="px-4">
                ...
                <div className="px-4 sm:px-20 md:px-20 text-center flex flex-col items-center">
                    <h1 className="text-4xl md:text-3xl font-medium text-center my-2">
                        Công cụ tính chỉ số cơ thể
                    </h1>
                    <p className="text-gray-400 text-lg md:text-base font-medium md:w-[80%]">
                        Tìm hiểu sức khỏe, định hình vóc dáng cùng công cụ tính
                        chỉ số cơ thể tuyệt vời!
                    </p>
                </div>
                <div className="px-10 sm:px-20 md:px-5 mt-8 md:flex md:items-center justify-center">
                    <Button
